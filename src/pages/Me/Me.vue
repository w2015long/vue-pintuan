...
<!--        <topnav :top='topnav'></topnav>-->
        <p class="areaWholesales-tilte">把握现在，赢得未来</p>
        <div class="cell">
            <p class="cell-nav">价格优势</p>
            <p class="cell-content">全网最低采购价，保证正品，物美价廉全网最低采购价全网最低采购价全网最低采购价全网最低采购价全网最低采购价全网最低采购价全网最低采购价</p>
        </div>
        <div class="cell">
            <p class="cell-nav active-color">批发区域</p>
            <div class="area-location" @click="toggleModalBox(true)">
                <span>所在地区</span>
                <i>&gt;</i>
            </div>
        </div>
        <div class="submit-btn">抢先入驻</div>
...
<script>
    //省份
    //http://nfxts.520shq.com/localQuickPurchase/brandSquare/region?type=1&pid=0

    //市区
    //http://nfxts.520shq.com/localQuickPurchase/brandSquare/region?type=2&pid=110385
            ...
            async getAreaData(type=1,pid=0) {
                ...
                switch (type) {
                    ...
                    case 2:
                        ...
                        break
                    case 3:
                        this.areaData = ret.data;
                        break
                    case 4:
                        this.streetData = ret.data;
                        break
                    default:
                        break
